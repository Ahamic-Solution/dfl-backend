    ...
    <body style="margin:0; padding:0; background:#f7f1eb; font-family:Arial, Helvetica, sans-serif;">
      <div style="max-width:600px; margin:24px auto; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #eadfd5;">
        <div style="background:#cf1f2c; padding:34px 28px; color:#ffffff;">
          ...
          <p style="margin:8px 0 0; font-size:14px;">Premium meat ordering made simple</p>
        </div>
        <div style="padding:34px 28px; color:#2a1d1b;">
          <h2 style="margin:0 0 14px; font-size:22px;">Welcome, ${name}!</h2>
          <p style="font-size:16px; line-height:1.7; color:#5f514b;">
            Thank you for joining <strong>ÖZEN ET</strong>. Use the verification code below to activate your account.
          </p>
          <div style="background:#fff7f3; border:2px dashed #cf1f2c; border-radius:10px; padding:22px; text-align:center; margin:28px 0;">
            <div style="font-size:38px; color:#cf1f2c; font-weight:800; letter-spacing:6px;">${activationCode || 'XXXXXX'}</div>
          </div>
